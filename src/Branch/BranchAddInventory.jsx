...
function BranchAddInventory({ setAddInventory}) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:3000/addbranchinventory",
        newItem,
        {
...
export default BranchAddInventory;
