...
function ApprovalUpdateInventory() {
...
return (
    <div className="flex flex-col w-full min-w-screen h-full min-h-screen bg-[#D9D9D9]">
      <h1 className="approval text-2xl font-500 text-[#133517] mt-4 font-poppins mr-4 p-4">Update Request</h1>
...
export default ApprovalUpdateInventory;