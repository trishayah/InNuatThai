  ...
  return (
    <div className="flex flex-row w-full min-h-screen bg-[#105D2B]">
      ...
      <div className="relative w-1/2 min-h-screen">
        ...
        <img
          className="absolute w-[80px] sm:w-[190px] lg:w-[350px] h-auto top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 object-contain z-10"
          alt="Logo"
          src={logo}
        />
      </div>

      {/* Right Side with Background Image and Login Form */}
      <div
        ...
        <div className="w-full sm:w-[420px] bg-[#D9D9D9] rounded-[15px] p-8 sm:p-12 flex flex-col items-center">
          ...
          <div className="w-full flex justify-center mt-4">
            <div className="text-center text-[#105D2B] text-sm sm:text-base font-family-semibold italic">
              <Link to='/VerifyEmail' className="underline text-loginTextBlue hover:text-blue-700 cursor-pointer" >Forgot Password?</Link>
            </div>
          </div>
        </div>
      </div>
