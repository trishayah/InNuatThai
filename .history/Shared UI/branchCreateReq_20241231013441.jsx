      ...
      <div className="flex items-center justify-center rounded-[15px] h-screen bg-[#164E28] mb-20">
        <div className="w-[900px] h-[600px] bg-[#105D2B] text-white rounded-[15px] p-6 shadow-md mb-20">
          ...
          <form className="grid grid-cols-2 gap-4">
            {/* Left Column: Date and Requester */}
            <div className="form-group">
              <label className="text-base font-poppins mb-2" htmlFor="date">Date</label>
              <input
                id="date"
                type="text"
            ...
            <div className="form-group">
              <label className="text-base font-poppins mb-2" htmlFor="requester">Requester</label>
              <input
                id="requester"
                type="text"
            ...
            {/* Right Column: Title and Branch */}
            <div className="form-group">
              <label className="text-base font-poppins mb-2" htmlFor="title">Title</label>
              <input
                id="title"
                type="text"
                value={request.title}
            ...
            <div className="form-group">
              <label className="text-base font-poppins mb-2" htmlFor="branch">Branch</label>
              <input
                id="branch"
                type="text"
