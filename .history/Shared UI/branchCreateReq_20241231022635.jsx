...
return (
    <div className="flex flex-col w-full min-w-screen h-full min-h-screen bg-[#D9D9D9]">
      ...
      <div className="requestTable">
       ...
       <div className="buttonContainer flex justify-between mt-4">
            <button onClick={handleCancel} className="button1 font-poppins font-medium bg-gray-300 px-4 py-2 rounded">
                Cancel
            </button>
            <button className="button4 font-poppins font-medium bg-green-500 px-4 py-2 rounded text-white">
                Next
            </button>
            </div>
