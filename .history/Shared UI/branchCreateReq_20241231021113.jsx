...
//               <input type="text" id="invtitle" className="form-input bg-white text-black p-2 rounded-[10px] font-poppins" />
//             </div>
//           </div>
...
//               <input type="text" id="invbranch" className="form-input bg-white text-black p-2 rounded-[10px] font-poppins" />
//             </div>
//           </div>
    ...
    <div className="flex flex-col w-full min-w-screen h-full min-h-screen bg-[#D9D9D9]">
      ...
      <div className="requestTable">
        ...
        <div className="form-row">
            <div className="form-group">
              <label htmlFor="price" className="date  text-black p-2 rounded-[10px] font-poppins">Date</label>
              <input type="text" id="invdate" className="form-input  text-black p-2 rounded-[10px] font-poppins" />
            </div>
            <div className="form-group">
